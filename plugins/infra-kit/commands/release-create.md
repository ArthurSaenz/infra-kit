...
If that resource cannot be read — it needs infra-kit 0.5.0 or newer — call the `mcp__infra-kit__release-create` tool directly and let its confirm gate drive the rest.
