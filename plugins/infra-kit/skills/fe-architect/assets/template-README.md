...
```bash
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/scaffold_feature.mjs [features-dir] [feature-name]
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/scaffold_feature.mjs apps/client/src/features user-profile
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/scaffold_feature.mjs apps/client/src/features user-profile --complex
```
...
```bash
cp -r "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/assets/feature-template [features-dir]/[feature-name]
...
```bash
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/validate_feature.mjs [features-dir]/[feature-name]
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/analyze_imports.mjs [features-dir]
node "${CLAUDE_PLUGIN_ROOT}"/skills/fe-architect/scripts/check_structure.mjs [features-dir]/[feature-name]
```
