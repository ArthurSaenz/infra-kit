...
to `docs/archive/mcp/mcp-session-env-refresh-plan.md` (revision 1, `pending approval`),
`docs/archive/mcp/mcp-session-env-refresh-plan.architect-review.md` (SOUND WITH AMENDMENTS; required A1, A3, A4,
